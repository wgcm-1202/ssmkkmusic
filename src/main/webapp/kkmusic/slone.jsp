                        ...
                        <div class="songlist-info-btn clearfix">
                            <ul class="col-btns fl" dd="0">
                                ...
                                <li class="col-collect">
                                    <a href="javascript:void(0)" class="btn-collect" title="" data-collected="">
												<span class="btn-text"><i class="btn-icon btn-collect-icon"></i><span class="collectText">收藏</span><em
                                                        class="to collectNum">19</em></span>
                        ...
                        <div class="songlist-list">
                            ...
                            <div class="table-box" id="songListView">
                                <div class="song-list-wrap">
                                    <ul>
                                        <c:forEach items="${list.songs}" var="song">
