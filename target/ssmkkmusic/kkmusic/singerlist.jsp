            ...
            <div class="nav-wrapper sup-nav-wrapper rsp-custom">
                <div class="screen-hd clearfix">
                    <ul class="sup-nav rsp-an-container">
                        ...
                        <li>
                            <a href="http://localhost:8080/ssmkkmusic_war_exploded/singer" onclick="window.parent.document.getElementById('iframe1').src='singerlist.jsp'" class="active " data-log="nav-singer">歌手</a>
                        </li>
                        <li>
                ...
                <div class="list-container artist-list">
                    <div class="adaptive-list" style="opacity: 1;">
                        ...
                        <div class="artist-item unselectable" style="flex: 0 0 16.6667%; max-width: 16.6667%;">
                            ...
                            <div class="info">
                                <div class="name"><a href="http://localhost:8080/ssmkkmusic_war_exploded/singerone?singerid=${singer.singer_id}">${singer.singer_name}</a></div>
